...
@section('content')
    ...
    <div class="container_right panel">
        ...
        <div class="title_pg f_avante">
            <div class="mr-2">Idiomas - Lista</div>
                    ...
                    <div class="buttons">
                        <div class="buttons show-buttons">
                            <button class="btn btn-large waves-effect"
                                data-href="{{ route('admin.idiomas.add') }}"
                                style="border: none">
                        ...
                        <div class="buttons hide-buttons">
                            ...
                            <button class="btn btn-large update waves-effect"
                                ...
                                data-link="{{ route('admin.idiomas.patch', 'status') }}"
                                data-method="patch">
                            ...
                            <button class="btn btn-large excluir waves-effect"
                                disabled="disabled"
                                data-link="{{ route('admin.idiomas.delete') }}"
                                style="border: none"
