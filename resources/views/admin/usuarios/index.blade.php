...
@section('content')
    ...
    <div class="container_right panel">
        ...
        <div class="title_pg f_avante">
            <div class="mr-2">Usuários - Lista</div>
        ...
        <div class="panel-content">
                    ...
                    <div class="buttons">
                        <div class="buttons show-buttons">
                            <button class="btn btn-large waves-effect"
                                    data-href="{{ route('admin.usuarios.add') }}"
                                    style="border: none">
                        ...
                        <div class="buttons hide-buttons">
                            ...
                            <button class="btn btn-large update waves-effect"
                                    ...
                                    data-link="{{ route('admin.usuarios.patch', 'status') }}"
                                    data-method="patch">
            ...
            <div class="area_dashboard panel-body p-0">
                <table class="datatable responsiveDatatable"
                       data-link="{{ route('admin.usuarios') }}">
                    <thead>
                        <tr>
                            ...
                            <th class="white-text">Grupo</th>
                            <th class="white-text">Email</th>
                            <th class="white-text">Ultimo Login</th>
