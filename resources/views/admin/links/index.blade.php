...
@section('content')
    ...
    <div class="container_right panel">
        ...
        <div class="title_pg f_avante">
            <div class="mr-2">Links Rápidos - Lista</div>
                    ...
                    <div class="buttons">
                        {{-- <div class="buttons show-buttons">
                            <button class="btn btn-large waves-effect"
                                data-href="{{ route('admin.links.add') }}"
                                style="border: none">
...
{{--
                            ...
                            <button class="btn btn-large update waves-effect"
                                ...
                                data-link="{{ route('admin.links.patch', 'status') }}"
                                data-method="patch">
                            ...
                            {{-- <button class="btn btn-large excluir waves-effect"
                                disabled="disabled"
                                data-link="{{ route('admin.links.delete') }}"
                                style="border: none"
